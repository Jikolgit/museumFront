  ...
  return (
    ...
    <group {...props} dispose={null}>
      <group position={[-102.97, 14.019, -22.926]}>
        ...
        <skinnedMesh geometry={nodes.model_template_1002.geometry} material={model_1txt.current} skeleton={nodes.model_template_1002.skeleton} />
      </group>
      <group position={[-85.893, 13.905, -32.539]} rotation={[0, 0.441, 0]}>
        ...
        <skinnedMesh geometry={nodes.body_2.geometry} material={model_2txt.current} skeleton={nodes.body_2.skeleton} />
      </group>
      <group position={[-116.233, 14.145, -34.014]} rotation={[0, -0.458, 0]}>
        ...
        <skinnedMesh geometry={nodes.body_3.geometry} material={model_3txt.current} skeleton={nodes.body_3.skeleton} />
      </group>
      <mesh geometry={nodes.posesocle.geometry} material={pose_1txt.current} position={[-111.254, 6.995, -30.365]} />
      <mesh geometry={nodes.armring.geometry} material={model_1txt.current} position={[-101.768, 15.058, -23.207]} rotation={[0, 0, -1.187]} />
      <mesh geometry={nodes.belt.geometry} material={model_1txt.current} position={[-102.945, 13.803, -22.992]} />
      <mesh geometry={nodes.head.geometry} material={model_1txt.current} position={[-102.997, 17.067, -22.979]} />
      <mesh geometry={nodes.neck.geometry} material={model_1txt.current} position={[-103.009, 16.619, -23.148]} />
      <mesh geometry={nodes.pose.geometry} material={pose_1txt.current} position={[-102.933, 9.325, -22.507]} />
      <mesh geometry={nodes.pose_2.geometry} material={pose_1txt.current} position={[-85.816, 9.325, -32.437]} rotation={[0, 0.441, 0]} />
      <mesh geometry={nodes.head_2.geometry} material={model_2txt.current} position={[-85.836, 16.801, -32.316]} rotation={[0, 0.441, 0]} scale={[0.75, 1, 1]} />
      <mesh geometry={nodes.wing_2.geometry} material={model_2txt.current} position={[-85.989, 15.189, -32.716]} rotation={[0, 0.441, 0]} />
      <mesh geometry={nodes.head__3.geometry} material={model_3txt.current} position={[-116.319, 17.671, -33.977]} rotation={[0, -0.458, 0]} />
      <mesh geometry={nodes.tail_3.geometry} material={model_3txt.current} position={[-115.664, 13.296, -35.091]} rotation={[-Math.PI / 2, 0, -0.458]} />
      <mesh geometry={nodes.belt_3.geometry} material={model_3txt.current} position={[-116.491, 13.211, -33.477]} rotation={[-0.248, -0.446, -0.109]} />
      <mesh geometry={nodes.pose_3.geometry} material={pose_1txt.current} position={[-116.575, 9.413, -33.249]} rotation={[0, -0.458, 0]} />
      ...
      <mesh geometry={nodes.recadevitrebar_2.geometry} material={recadeSocle_txt.current} position={[34.951, 21.254, 2.957]} rotation={[0, -1.571, 0]} />
      <mesh geometry={nodes.recadevitrebar_3.geometry} material={recadeSocle_txt.current} position={[29.839, 21.254, -34.906]} rotation={[0, -Math.PI / 4, 0]} />
      <mesh geometry={nodes.recadesocle_1.geometry} material={recadeSocle_txt.current} position={[-16.259, 8.543, -38.083]} />
      <mesh geometry={nodes.recadevitrebar_1.geometry} material={recadeSocle_txt.current} position={[-16.259, 21.254, -38.083]} />
      ...
      <mesh geometry={nodes.affiche_1.geometry} material={scene_txt.current} position={[-98.857, 21.273, -59.831]} />
      ...
      <mesh onClick={()=>{valContexte.setshowInfo_1(c=> c = !valContexte.showInfo_1)}} geometry={nodes.desc.geometry} material={troneSocle_txt.current} position={[-195.346, 10.349, -29.344]} rotation={[-0.41, -0.508, -0.208]} />
